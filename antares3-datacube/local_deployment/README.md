To avoid having different packages and dependencies we use same image in docker hub to deploy k8s deployment and dummy cluster locally without LUSTRE. This docker image uses a `bionic` version of ubuntu.
